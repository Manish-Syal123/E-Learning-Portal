  ...
  return (
    <div>
      ...
      <div>
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <div className="flex">
              ...
              <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                Welcome to Manish{" "}
                <span className="text-primary">Ed-Tech Academy</span>{" "}
              </h1>
              <Image
                src={"/panda.png"}
                width={100}
                height={100}
                className="transform -scale-x-100 object-cover"
                alt="panda"
              />
            </div>
            <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
              Crafted best Courses with real world projects, and hands on
              experience.
            </p>
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              ...
              {/* <a
                href="https://youtu.be/Zj_r9SoTbqc"
                target="_blank"
        ...
        <section className="py-8 -mt-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 rounded-lg shadow-2xl">
          <h2 className="font-bold text-3xl">How it Works?</h2>
          <h2 className="text-md text-gray-500">
            Start learning with any Free or Paid Courses
          </h2>
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10 cursor-default"
            >
              ...
              <p className="mt-1 text-sm text-gray-400">
                we make sure to provide you best quality content that can help
                you grow. You can choose between Free and Paid Courses. Most of
                our courses are free of cost.
              </p>
            </div>

            {/* column 2 */}
            <div className="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10 cursor-default">
              {/* <Edit className="h-8 w-8" /> */}
              <IoChatboxEllipses className="h-8 w-8 text-indigo-700" />

              <h2 className="mt-4 text-xl font-bold text-black">Progress</h2>

              <p className="mt-1 text-sm text-gray-400">
                You'll be able to track your Progress. can switch to any chapter
                any time and mark it as completed.
              </p>
            </div>
            ...
            <div className="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10 cursor-default">
              ...
              <p className="mt-1 text-sm text-gray-400">
                In the Pro Plan we will provide you with all the premium
                features, like email support, practice question set and many
                more.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <a
              href="/dashboard"
              className="inline-block rounded bg-primary px-12 py-3 text-sm font-medium text-white transition hover:bg-indigo-500 focus:outline-none focus:ring focus:ring-yellow-400"
            >
              Get Started Today
            </a>
          </div>
